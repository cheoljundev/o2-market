...
class OrderDaoTest {
    ...
    void findByOrderNo() {
        ...
        // when
        AdminOrderDetailDto order = orderDao.findByOrderNo(1L);
    ...
    void findRange() {
        ...
        // when
        List<AdminOrderListDto> orders = orderDao.findRange(1, 10, searchCond);
    ...
    void findPages() {
        ...
        // when
        int pages = orderDao.findPages(searchCond, 10);
