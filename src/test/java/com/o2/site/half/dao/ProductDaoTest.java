...
class ProductDaoTest {
    ...
    @Test
    void findRange() {
        List<Product> products = productDao.findRange(1, 10);
    ...
    void findRangeWithConditions() {
        ...
        List<UserListProductDto> products = productDao.findRange(1, 10, searchCond);
        Assertions.assertThat(products.size()).isEqualTo(10);
    }
    ...
    @Test
    void findPages() {
        int count = productDao.findPages(10);
    ...
    void findPagesWithCondition() {
        ...
        int count = productDao.findPages(10, searchCond);
        Assertions.assertThat(count).isEqualTo(1);
    }
}