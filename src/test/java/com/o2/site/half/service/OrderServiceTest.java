...
class OrderServiceTest {
    ...
    void findAll() {
        ...
        // when
        List<Order> orders1 = orderService.findAll(orderSearchCond1);
        String buyerMemberId = orders1.get(0).getBuyerMemberId();

        List<Order> orders2 = orderService.findAll(orderSearchCond2);
        String buyerPhone = orders2.get(0).getBuyerPhone();

        List<Order> orders3 = orderService.findAll(orderSearchCond3);
        String recipientName = orders3.get(0).getRecipientName();

        List<Order> orders4 = orderService.findAll(orderSearchCond4);
    ...
    void findRange() {
        ...
        // when
        List<Order> orders = orderService.findRange(1, 2, orderSearchCond);
    ...
    void insertOrder() {
        ...
        InsertOrderDto insertOrderDto = InsertOrderDto.builder()
                ...
                .build();
        orderService.insertOrder(insertOrderDto);
        OrderSearchCond orderSearchCond = OrderSearchCond.builder()
                .build();
    ...
    void updateOrder() {
        ...
        // then
        Order order = orderService.findByOrderNo(1L);
